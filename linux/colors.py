...
TomorrowNight = [
    ...
    ["#1d1f21", "#1d1f21"], # bg        1
    ["#c5c8c6", "#c5c8c6"], # fg        2
    ["#373b41", "#373b41"], # color01   3    
    ["#cc6666", "#cc6666"], # color02   4    
    ["#b5bd68", "#b5bd68"], # color03   5    
    ["#e6c547", "#e6c547"], # color04   6   
    ["#81a2be", "#81a2be"], # color05   7    
    ["#b294bb", "#b294bb"], # color06   8    
    ["#70c0ba", "#70c0ba"]  # color15   9    
    ]
